	<div class="pp-article-shares-links-blog">
		...
		<?php if(bdayh_get_option('article_home_fb') == 1){ ?>
		...
		<?php if(bdayh_get_option('article_home_gp') == 1){ ?>
		  <div class="pp-google">
		...
		<?php if(bdayh_get_option('article_home_tweet') == 1){ ?>
		...
		<?php if(bdayh_get_option('article_home_in') == 1){ ?>
		...
		<?php if(bdayh_get_option('article_home_pin') == 1){ ?>
		...
		<?php if(bdayh_get_option('article_home_su') == 1){ ?>
