...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri(). '/shortcode/shortcodes/assets/js/lib.js' ?>"></script>
<link href="<?php echo get_template_directory_uri(). '/shortcode/shortcodes/assets/css/notifications.css' ?>" type="text/css" rel="stylesheet" media="all"  />
